...
import pluginHtml from './public/clappr-responsive-container-plugin.html'
import pluginStyle from './public/style.sass'

export default class ClapprResponsiveContainerPlugin extends UICorePlugin {
  get name() { return 'clappr-responsive-container-plugin' }
